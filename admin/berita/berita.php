...
<head>
  ...
  <title>Admin - Sistem Pakar Diagnosa Penyakit Durian Montong</title>
    ...
    <div class="pagetitle">
      ...
      <nav style="--bs-breadcrumb-divider: '>';">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Artikel Berita</li>
        </ol>
      </nav>
      <hr>
    </div><!-- End Page Title -->
              ...
              <?php
                ...
                ?>
                  <tr>
                    ...
                    <td><img src=" img/<?php echo ($data['gambar']);  ?>" width="200" ></td>
                    <td><a href="./editberita.php?kdubahberita=<?php echo $data['id_berita']; ?>" class="btn btn-warning btn-sm">Edit</a></td>
                    <td><a onClick="return HapusData('<?php echo $data['id_berita']; ?>');" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusmodal">Delete</a>
                    </td>
                  </tr><?php } ?>
              </tbody>
            </table>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mx-auto">Tambah Artikel Berita</h5>
        </div>
        <div class="modal-body">
          <form method="post" action="./simpanberita.php" enctype="multipart/form-data">
            <div class="form-group mb-2">
              <label for="id_berita">Kode Berita :</label>
