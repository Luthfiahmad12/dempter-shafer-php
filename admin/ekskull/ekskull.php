...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="../ekskull/ekskull.php" class="active">
          ...
          <div class="table-responsive">
            <table id="myTable" class="table table-striped table-hover table-bordered">
              ...
              <tbody>
                <?php
                include "../../koneksi.php";
                $sql = "SELECT * FROM tb_ekskull  ORDER BY code_ekskull";
                ...
                ?>
                  <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $data['code_ekskull']; ?></td>
                    <td><?php echo $data['nama']; ?></td>
                    <td><?php echo $data['deskripsi']; ?></td>
                    <td>
                      <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editmodal-<?php echo $data['id']; ?>">Edit</button>
                    </td>
                  ...
                  <!-- modal edit -->
                  <?php
                  $edit_code = $data['code_ekskull'];
                  $edit_nama = $data['nama'];
                  $edit_decs = $data['deskripsi'];
                  ?>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title mx-auto">Edit Data Ekskull</h5>
                        </div>
                        <div class="modal-body">
                          <form method="post" action="../proses/edit_ekskull.php">
                            <div class="form-group mb-2">
                              <label for="code_ekskull">Kode :</label>
                              <input type="text" class="form-control" id="code_ekskull" name="code_ekskull" value="<?php echo $data['code_ekskull']; ?>">
                            ...
                            <div class="d-grid gap-2">
                              <button type="submit" class="btn btn-secondary mt-4 btn-sm">Update</button>
  ...
  <div id="tambahmodal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mx-auto">Tambah Data Ekstrakurikuler</h5>
        </div>
        <div class="modal-body">
          <form method="post" action="../proses/simpan_ekskull.php">
            <div class="form-group mb-2">
              <label for="code_ekskull">Kode :</label>
              <input type="text" class="form-control" id="code_ekskull" name="code_ekskull" autofocus required>
            </div>
            <div class="form-group mb-2">
              <label for="nama">Nama Ekstrakurikuler :</label>
