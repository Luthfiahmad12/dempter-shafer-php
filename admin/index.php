...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <!-- <h4>Dashboard - Admin Diagnosa Penyakit Durian Montong</h4> -->
  ...
  <main id="main" class="main">
    ...
    <section>
      ...
      <br>
      <p>Sistem Pakar Diagnosa dan Penanganan Durian Montong ini adalah sebuah sistem yang digunakan untuk mendiagnosa awal jenis
        penyakit yang menyerang pada durian montong berdasarkan gejala yang dialami. Proses diagnosa dengan menentukan
        gejala-gejala yang terjadi pada durian montong, dengan menggunakan metode Dempster Shafer maka sistem dapat memberikan
