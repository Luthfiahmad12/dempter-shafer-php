...
<head>
  ...
  <title>Admin - Sistem Pakar Minat Bakat Ekstrakurikuler</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="../indikator/indikator.php" class="active">
            ...
            <table id="myTable" class="table table-striped table-hover table-bordered">
              <thead>
                <tr>
                  ...
                  <th></th>
                  <th><input type="hidden" id="texthapus"></th>
                </tr>
              </thead>
              <tbody>
                <?php
                include "../../koneksi.php";
                $sql = "SELECT * FROM tb_indikator  ORDER BY kode_indikator";
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editmodal-<?php echo $data['id']; ?>">Edit Data</button>
                    </td>
                    <td>
                      <a onClick="return HapusData('<?php echo $data['id']; ?>');" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusmodal">Delete</a>
                    </td>
                  </tr>
                  ...
                  <?php
                  $edit_kd_indikator = $data['kode_indikator'];
                  $edit_indikator = $data['indikator'];
                  ?>
                  <div class="modal fade" id="editmodal-<?php echo $data['id']; ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title mx-auto">Edit Data Indikator</h5>
                        </div>
                        <div class="modal-body">
                          <form method="post" action="../proses/edit.php">
                            <div class="form-group mb-2">
                              <label for="kode_indikator">Kode Indikator :</label>
                              <input type="text" class="form-control" id="kode_indikator" name="kode_indikator" value="<?php echo $edit_kd_indikator; ?>">
                              <input name="id" type="hidden" value="<?php echo $data['id']; ?>">
                            </div>
                            <div class="form-group mb-2">
                              <label for="indikator">Nama Indikator :</label>
                              <input type="text" class="form-control" id="indikator" name="indikator" value="<?php echo $edit_indikator; ?>">
                            </div>
                            <div class="d-grid gap-2">
                              <button type="submit" class="btn btn-secondary mt-4 btn-sm">Update Data</button>
  ...
  <div id="tambahmodal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mx-auto">Tambah Data Indikator</h5>
        </div>
        <div class="modal-body">
          <form method="post" action="../proses/simpan.php">
            <div class="form-group mb-2">
              <label for="kode_indikator">Kode Indikator :</label>
              <input type="text" class="form-control" id="kode_indikator" name="kode_indikator">
            </div>
            <div class="form-group mb-2">
              <label for="indikator">Nama Indikator :</label>
